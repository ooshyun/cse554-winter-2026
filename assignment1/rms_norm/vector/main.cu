 ...
 */
 ...
 void benchmark_performance() {
     ...
     float time_basic = measure_rms_norm_vector_time(rms_norm_vector_basic,
                                                      d_input, d_output, n,
                                                      num_iterations);
     ...
     printf("\nTesting FAST kernel...\n");
     float time_fast = measure_rms_norm_vector_time(rms_norm_vector_fast,
                                                     d_input, d_output, n,
                                                     num_iterations);
     ...
     printf("Status: %s\n", bandwidth_fast > 200.0f ? "✓ PASSED" : "✗ NEEDS OPTIMIZATION");
